...
var Person = function () {
    function Person() {
        var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'tba';
...
var me = new Traveller('Person Wilkins');
var other = new Traveller('Student Wilkins', 23, 'Botswana');
